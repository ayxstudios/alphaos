  ...
  const pipeline: CountLink[] = [
    {
      ...
      detail: "Did not run on time, or ran with errors",
    },
    {
      label: "Shops not syncing",
      count: input.staleShopCount,
      href: "/settings",
      tone: input.staleShopCount > 0 ? "danger" : "success",
      detail: "No new orders pulled in over an hour",
    },
    {
      label: "Mailbox not updating",
      count: input.gmailStallCount,
      href: "/health",
      tone: input.gmailStallCount > 0 ? "danger" : "success",
      detail: "New customer email is not being picked up",
    },
    {
      ...
      detail: "Waiting for the mailbox",
    },
    {
      ...
      detail: "A customer email did not send",
    },
    {
      label: "Replies with no order",
    ...
    },
    {
      ...
      detail: "Waiting for details or photos over 2 days",
    },
    {
      label: "Proofs with no answer",
      count: input.proofNoResponse,
      href: "/orders?view=awaiting_customer",
      tone: input.proofNoResponse > 0 ? "warning" : "success",
      detail: "No reply from the customer in 3 days",
    },
  ];
