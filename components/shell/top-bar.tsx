        ...
        <Popover
          ...
          trigger={
            <>
              <Bell size={18} />
              {unread > 0 && (
                <span className="absolute -right-0.5 -top-0.5 flex min-w-4 items-center justify-center rounded-full bg-rose px-1 text-xs font-semibold leading-4 text-surface">
                  {unread > 9 ? "9+" : unread}
                </span>
              )}
            </>
